...
This repository contains the worked sample app for the [Grails with Micronaut HTTP Client](https://grails.apache.org/guides/grails-micronaut-http/5/guide/index.html) guide on the Apache Grails site.
